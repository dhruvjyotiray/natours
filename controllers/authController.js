...
exports.login = catchAsync(async (req, res, next) => {
  ...
  //3. If all is CLEAR, send token to the client
...
exports.isLoggedIn = catchAsync(async (req, res, next) => {
  if (req.cookies.jwt) {
    try {
      ...
      // If there is an error verifying the JWT, simply continue without setting res.locals.user
      return next();
    }
  }
  next();
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  if (!user) return next(new AppError("No user with email exists!", 404));
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  //3. Updated passwordChangedAt property for the user
